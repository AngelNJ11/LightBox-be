...
public class TicketPurchaseServiceImpl implements TicketPurchaseService{
 @Autowired
    ...
    public List<Funcion> getFuncionesPorPelicula(int idPelicula) {
        return jdbcTemplate.query("EXEC usp_FuncionesPorPelicula ?",
            new Object[]{idPelicula}, (rs, rowNum) -> {
                Sala s = new Sala();
    ...
    public List<AsientoPurchase> getAsientosPorFuncion(int idFuncion) {
        return jdbcTemplate.query("EXEC usp_ObtenerAsientosPorFuncion ?",
    ...
    public Sala getSalaPorId(int idSala) {
        return jdbcTemplate.queryForObject("EXEC usp_GetSalaById ?",
    ...
    public Cliente getClientePorIdPersona(int idPersona) {
        return jdbcTemplate.queryForObject("EXEC usp_GetClienteByIdPersona ?",
    ...
    public Funcion getFuncionPorId(int idFuncion) {
        return jdbcTemplate.queryForObject("EXEC usp_GetFuncionById ?",
            new Object[]{idFuncion}, (rs, rowNum) -> {
                Sala s = new Sala();
                s.setIdSala(rs.getInt("id_sala"));
